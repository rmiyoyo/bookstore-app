...
**Book Store App:** The Bookstore website is constructed using React and Redux, offering users the capability to showcase a catalog of books, add new books to the collection, and easily remove specific books as desired. 
...
```sh
cd my-folder
git clone git@github.com:rmiyoyo/bookstore-app.git
```
